...
export const updateTransaction: AsyncThunk<void, { id: string; transaction: ApiTransaction }, {
  dispatch: AppDispatch
}> = createAsyncThunk<void, { id: string, transaction: ApiTransaction }>(
...
export const fetchOneTransaction: AsyncThunk<ApiTransaction, string, {
  dispatch: AppDispatch
}> = createAsyncThunk<ApiTransaction, string>(
